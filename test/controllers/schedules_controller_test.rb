...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { end_at: @schedule.end_at, start_at: @schedule.start_at } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { end_at: @schedule.end_at, start_at: @schedule.start_at } }
