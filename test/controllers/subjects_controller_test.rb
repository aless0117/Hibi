...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { hora: @subject.hora, name: @subject.name, user_id: @subject.user_id } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { hora: @subject.hora, name: @subject.name, user_id: @subject.user_id } }
